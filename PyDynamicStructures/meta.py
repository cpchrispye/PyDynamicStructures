...
class MetaClass(MetaBase):
    ...
    def __getattr__(self, item):
        if item == '_state_':
            super(MetaClass, self).__setattr__('_state_', StateDict())
            return self._state_
        try:
...
class MetaList(MutableSequence, MetaBase):
    #__slots__ = ('_state_',)
    ...
    def __getattr__(self, item):
        if item == '_state_':
            super(MetaList, self).__setattr__('_state_', StateList())
            return self._state_
        raise AttributeError()
...
class MetaDict(MutableMapping, MetaBase):
    #__slots__ = ('_state_',)
    ...
    def __getattr__(self, item):
        if item == '_state_':
            super(MetaDict, self).__setattr__('_state_', ListStore())
            return self._state_
        raise AttributeError()
...
class MetaDictClass(MetaClass, MetaDict):
    #__slots__ = ('_state_',)
    pass